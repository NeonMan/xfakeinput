#
# simple-mapping-auto.py
#
# This script swill emulate the first XInput pad using the first available
# DirectInput pad. Raises an exception if no devices found.
#
...
#in this case the first available
if xfi.num_devices() == 0:
